...
def passGen(user_number):
    ...
    mix_words(words)
    chosen_words = words[:user_number]
...
def rep_with_upper(s):
    ...
    return s.replace(char_to_replace, char_to_replace.upper())
...
def main():
    user_number = int(input("Specify a numerical input between 3 and 7. "))

    while user_number < 3 or user_number > 7:
        print("Invalid input!")
        user_number = int(input("Specify a numerical input between 3 and 7. "))

    first_password = passGen(user_number)
    password_with_upper = rep_with_upper(first_password)
    new_password = swap_letters(password_with_upper)

    print("Old password:", first_password)
    print("New version of the password:", new_password)

    name_first_letter = input("Enter the first letter of your name: ")
    if search_letter(new_password, name_first_letter):
        print("The first letter of your name is in the final password.")
    else:
        print("The first letter of your name is NOT in the final password.")
